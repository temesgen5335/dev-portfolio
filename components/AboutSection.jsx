  ...
  return (
    <div className="mb-5">
      ...
      <div className="h-2 rounded-full bg-gray-700">
        <motion.div
          className="h-full rounded-full bg-gradient-to-r from-[#BF7632] to-[#EA42A2]"
          initial={{ width: 0 }}
          animate={{ width: `${width}%` }}
          transition={{ duration }}
        />
          ...
          {[
            ...
            >
              {/* <h3 className="text-lg font-bold flex items-center mb-2">
                <span className="text-2xl text-[#BF7632] mr-2">{cat.icon}</span> {cat.title}
              </h3> */}
    ...
    <section className="text-white" id="about" ref={ref}>
      <div className="max-w-7xl mx-auto px-6 py-16">
        ...
        >
          ...
          <div>
            <h2 className="text-4xl font-bold mb-4 text-[#BF7632]">About Me</h2>
