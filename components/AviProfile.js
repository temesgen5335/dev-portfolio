      ...
      >
        <div className="flex flex-col sm:flex-row items-center gap-6">
          ...
          <div className="flex-1 text-center sm:text-left">
            ...
            <h3 className="text-[#BF7632] text-lg font-medium mb-2">
              AI Software Engineer
            </h3>
            <p className="text-sm text-[#adb7be] mb-4 leading-relaxed">
              Certified AI Engineer · Building Scalable Full stack Systems
            </p>
            ...
            <div className="flex justify-center sm:justify-start gap-3">
              {[
                ...
                <motion.a
                  ...
                  className="w-10 h-10 flex items-center justify-center rounded-full bg-[#2d3748] hover:bg-[#BF7632]/90 transition-all duration-300 shadow-md"
