...
const EmailSection = () => {
  ...
  return (
    <main
      id="contact"
      className="min-h-screen py-28 px-6 md:px-24 bg-[#0D0F1A] text-white"
    >
      <div className="grid md:grid-cols-2 gap-12 items-start">
        {/* Left - Message & Socials */}
        <div>
          <h2 className="text-3xl font-bold mb-4 text-[#BF7632]">
            Let&apos;s Connect
          </h2>
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2 bg-[#0F111A] border border-[#2A2D3A] rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-[#BF7632]"
                />
              </div>
              ...
              <button
                type="submit"
                className="w-full bg-[#BF7632] hover:bg-[#5c3dd0] text-white font-medium py-2.5 px-4 rounded-lg transition duration-300"
              >
                Send Message
              </button>
            </form>
