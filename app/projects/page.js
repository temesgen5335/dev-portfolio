    ...
    <>
      ...
      <main className="min-h-screen bg-[#0d0d11] text-[#e0e0ff] px-6 py-12">
        <div className="max-w-6xl mx-auto">
          <h1 className="text-4xl md:text-5xl font-bold text-center text-[#BF7632] mb-2">
            My Projects
          </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {projects.map((project, index) => (
              <div
                key={index}
                className="bg-[#1a1a22] border border-[#292940] hover:border-[#BF7632] rounded-lg p-6 transition duration-300 hover:-translate-y-1"
              >
                <div className="flex justify-between items-start">
                  <div>
                    <h2 className="text-xl font-semibold text-[#BF7632] mb-1">
                      {project.title}
                    </h2>
                    ...
                    <div className="mt-3 flex flex-wrap gap-2">
                      {project.tags.map((tag, i) => (
                        <span
                          key={i}
                          className="bg-[#2b2b3d] text-[#BF7632] text-xs px-2 py-1 rounded-md"
                        >
                          {tag}
                        </span>
                      ))}
                    ...
                    <div className="mt-4 flex gap-4">
                        ...
                        <a
                            ...
                            className="text-sm text-[#BF7632] border border-[#BF7632] px-3 py-1 rounded hover:bg-[#BF7632] hover:text-black transition"
                        >
                            Repo
                        </a>
                        )}
                  ...
                  <button
                    ...
                    className="text-[#BF7632] ml-4 text-2xl"
                  >
                    {expandedIndex === index ? "−" : "+"}
                  </button>
                </div>
